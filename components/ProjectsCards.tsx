...
export function TabsDemo() {
  ...
  return (
    <div
      id="projects"
      ref={ref}
      className="h-[30rem] md:h-[50rem] [perspective:1000px] relative b flex flex-col max-w-5xl mx-auto w-full items-center justify-center my-10 scroll-mt-24 transition ] md:px-10"
    >
